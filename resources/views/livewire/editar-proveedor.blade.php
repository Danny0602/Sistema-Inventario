    ...
    <form wire:submit.prevent="editarProveedor" class="md:w-1/2 space-y-5" novalidate>
        ...
        <div>
            <x-primary-button class=" bg-red-600 hover:text-black hover:bg-red-600 w-full justify-center py-3 font-black text-base">Guardar Cambios</x-primary-button>
        </div>
    </form>
